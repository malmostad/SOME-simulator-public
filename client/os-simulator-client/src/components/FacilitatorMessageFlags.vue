<template>
  <div v-if="show">
    <div class="container">
        ...
        <span>Flaggor:</span>
        <p v-if="message.botReplyProperties & 2">
        <Tooltip content="Positiva">
            <svg
                    width="16px"
                    height="16px"
                    viewBox="0 0 25 25"
                ...
                <span class="text-mode" v-if="textMode">Positiva</span>
        </Tooltip>
        </p>

        <p v-if="message.botReplyProperties & 4">
            <Tooltip content="Negativa">
                <svg
                    width="16px"
                    height="16px"
                    viewBox="0 0 25 25"
                ...
                <span class="text-mode" v-if="textMode">Negativa</span>
            </Tooltip>
        </p>
        
        <p v-if="message.sessionLogTag & 2">
            <Tooltip content="Faktamässighet">
                <svg
                        width="13px"
                        height="16px"
                        viewBox="0 0 13 16"
                ...
                <span class="text-mode" v-if="textMode">Faktamässighet</span>
            </Tooltip>
        </p>
        <p v-if="message.sessionLogTag & 4">
            <Tooltip content="Empati">
                <svg
                        width="17px"
                        height="16px"
                        viewBox="0 0 17 16"
            ...
            <span class="text-mode" v-if="textMode">Empati</span>
            </Tooltip>
        </p>
        <p v-if="message.sessionLogTag & 8">
        <Tooltip content="Tonalitet">
            <svg
                    width="17px"
                    height="16px"
                    viewBox="0 0 17 16"
            ...
            <span class="text-mode" v-if="textMode">Tonalitet</span>
        </Tooltip>
        </p>
    </div>
...
export default class FacilitatorMessageFlags extends Vue {
    @Prop({required: true})
    public message!: SessionLog;
    @Prop({ default: Boolean as () => false })
    public textMode!: boolean;

    get show() {
        if (this.message.botReplyProperties > 1 && this.message.botReplyProperties !== null) {
            return true;
        }
        if (this.message.sessionLogTag > 1 && this.message.sessionLogTag !== null) {
            return true;
        }
        return false;
    }
...
<style scoped lang="scss">
    ...
    div {
        @include typography("bold", 16, $dark-gray2);
        display: block;     
    }
